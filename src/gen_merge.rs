...
// dates not the same
            ...
            if !bolusenum {
                ...
                if durationn.num_seconds() < 2 {
                    if mbeforebox_check {
                        if datenumother > 998 {
                            errstring = "before checked and selected file number and previous file number too close".to_string();
                            errcode = 5;
                        } else {
                            datetox = dateother;
                        ...
                        if datenumother < 1 {
                            errstring = "selected file number and after file number too close".to_string();
                            errcode = 6;
                        } else {
                            datetox = dateother;
                            if datenumother > 1 {
